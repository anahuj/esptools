...
int parsebuffer_race(void *b)
{
  ...
  while (buffer_eof(b) != 1) {
	...
	printf("%f\n",f);
      ...
      printf("RACE/YNAM %i\n",n);
      n = buffer_read_int(b);
      printf("Younger Race FormID %i\n",n);
    } else if (strcmp(s,"NAM2") == 0) { // F
      n = buffer_read_short(b);
      printf("RACE/NAM2 %i\n",n);
      // Empty.
      ...
      printf("RACE/VTCK %i\n",n);
      n = buffer_read_int(b);
      printf("Default Voice Type Male %i\n",n);
      n = buffer_read_int(b);
      printf("Default Voice Type Female %i\n",n);
    } else if (strcmp(s,"MODT") == 0) { // F
      n = buffer_read_short(b);
      printf("RACE/MODT %i\n",n);
      parse_modt(b,n);
